...
**2. Anti-drift mechanisms (installed in CLAUDE.md).**
...
- **Opportunity** (~15–20 / phase boundaries) — controlled open-mindedness; candidates parked in `/OPPORTUNITY_REGISTER.md`, none pursued without a deliberate decision (or North Star amendment).
...
**4. Supersedes:** the previous "PERIODIC MAINTENANCE CADENCES" block in CLAUDE.md (Housekeeping/Research Audit/Adversarial/Health-Check) is replaced by this system. File-size budgets are retained under Housekeeping.
